...
Training = "D:\\ADLA\\ADLA\\Models\\Train1"
PRE = "D:\\ADLA\\ADLA\Models\\Pretrain1"
Indicators = "D:\\ADLA\\ADLA\\IndicatorsResults"
...
def run(cancer_name, data, lr):
    ...
    #you should input the best model number before the ADLA !
    model = torch.load("{}\\{}ADLA_best_model.pth".format(model_path, cancer_name)) 
    cvae_model = torch.load('{}\\{}\\{}_pretrain.pth'.format(PRE, cancer_name, cancer_name)).to(
        device=device)
